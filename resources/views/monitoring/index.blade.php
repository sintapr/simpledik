...
<div class="row page-titles mx-0 align-items-center justify-content-between">
    ...
    <div class="col-auto">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Data Monitoring Semester</li>
        </ol>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Data Monitoring Semester</h4>

            {{-- Form Pencarian --}}
            <form method="GET" class="row mb-3">
                <div class="col-md-6">
                    <input type="text" name="search" class="form-control" placeholder="Cari NIS, kelas, atau guru..." value="{{ request('search') }}">
                </div>
                <div class="col-md-2">
                    ...
                    <tbody>
                        @forelse($monitoring as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($userRole !== 'kepala_sekolah')
                                        <a href="{{ route('monitoring.edit', $item->id_rapor) }}" class="btn btn-sm btn-warning">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{ route('monitoring.destroy', $item->id_rapor) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin hapus?')">
                                            @csrf
                                            @method('DELETE')
